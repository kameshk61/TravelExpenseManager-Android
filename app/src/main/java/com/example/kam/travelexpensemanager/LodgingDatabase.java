...
public class LodgingDatabase extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lodging_database);
    ...
    public void onClick(View v) {
        if(v==b1)
        {
            ...
            try {
                db.execSQL("insert into Lodging VALUES('" + id + "','" + place + "','" + cost + "')");
