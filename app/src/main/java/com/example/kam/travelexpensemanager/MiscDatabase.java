...
public class MiscDatabase extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_misc_database);
    ...
    public void onClick(View v) {
        if(v==b1)
        {
            ...
            try {
                db.execSQL("insert into Misc VALUES('" + id + "','" + name + "','" + cost + "')");
